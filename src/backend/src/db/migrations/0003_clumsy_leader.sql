...
ALTER TABLE "api_request_logs" ALTER COLUMN "user_id" SET DATA TYPE text;--> statement-breakpoint
ALTER TABLE "bots" ALTER COLUMN "user_id" SET DATA TYPE text;--> statement-breakpoint
